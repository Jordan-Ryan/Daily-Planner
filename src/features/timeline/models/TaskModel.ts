...
export class TaskModel {
  ...
  private static tasks: Task[] = [
    ...
    // Overlapping events for testing
    {
      ...
      description: 'Important client meeting about Project Alpha',
      complete: false,
    },
    {
      id: '20',
    ...
    },
    {
      ...
      description: 'Weekly painting class',
      complete: false,
    },
    {
      id: '23',
      ...
      calendar: 'Family',
      location: 'Home',
      description: 'Family pizza night with friends',
      complete: false,
    },
    {
      id: '24',
      ...
      description: 'Watch the latest Marvel movie',
      complete: false,
    },
    // Direct overlapping events from different calendars
    {
      id: '25',
      icon: '🏥',
      title: 'Doctor Appointment',
    ...
    },
    {
      ...
      calendar: 'Family',
      location: 'Home',
      description: 'Board games with the family',
      complete: false,
      isDirectOverlap: true,
      overlapGroup: 'art-family',
    },
